...
<head lang="it" dir="ltr">
    ...
    <title>Magazzino - Already Delivered Order </title>
    ...
    <div class="container" style="height: 100vh;">
        <div class="row content">
            ...
            <div class="col-5">
                <div class="row">
                    <div class="col-12">
                        <h6 class="content-header">Ordine Consegnato</h6>
                        <hr class="content-line">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h1 class="content-title">Hai controllato <br> sotto il tappeto?</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
