...
<head lang="it" dir="ltr">
    ...
    <title>Magazzino - Invalid Delivery Code</title>
...
<body id="invalidDeliveryCode">

    <div class="container" style="height: 100vh;">
        <div class="row content">
            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-xs-12 col-12"><img class="image" src="./assets/img/invalid-delivery-code.svg" alt="" draggable='false'></div>
            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-xs-12 col-12">
                <div class="row">
                    <div class="col mt-3">
                        <h6 class="content-header">Codice non trovato</h6>
                        <hr class="content-line">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <h1 class="content-title">Errore o <br> invenzione?</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
