...
<body id="alreadyResentOrder">

    <div class="container" style="height: 100vh;">
        <div class="row content">
            <div class="col-7"><img class="image" src="./assets/img/already-resent-order.svg" alt="" draggable='false'></div>
            <div class="col-5">
                <div class="row">
                    <div class="col-12">
                        <h6 class="content-header">Ordine già in restituzione</h6>
                        <hr class="content-line">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h1 class="content-title">Hai cambiato idea?</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <p class="content-description">
                            Il tuo ordine è in <b>fase di restituzione</b>, per piacere attendi che ti venga inviata una <b>mail</b> quando ti sarà rispedito il nuovo prodotto.
                        </p>
                    </div>
                </div>
                <div class="row">
