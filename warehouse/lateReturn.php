...
<head lang="it" dir="ltr">
    ...
    <title>Magazzino - Late Return</title>
...
<body id="lateRequest">
    ...
    <div class="container" style="height: 100vh;">
        <div class="row content">
            <div class="col-7"><img class="image" src="./assets/img/late-request.svg" alt="" draggable='false'></div>
            <div class="col-5">
                <div class="row">
                    <div class="col-12">
                        <h6 class="content-header">Tempus fugit</h6>
                        <hr class="content-line">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h1 class="content-title">Come passa il tempo quando ci si diverte!</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <p class="content-description">
                            Sembra che tu abbia provveduto alla <b>restituzione del pacco</b> oltre la soglia di
                            <b>tempo minimo </b>di <b>14 giorni</b>. Avresti dovuto provvedere prima! </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
