...
<head lang="it" dir="ltr">
    ...
    <title>Magazzino - Damaged Order Choice</title>
...
<body id="damagedOrderChoice">
    <div class="container">
        <div class="card principalCard col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12 col-12 mx-auto pl-0 pr-0">
            <div class="card-body-header">
                <p class="d-inline"><b>Reclamo per danneggiamento</b></p>
            </div>
            <p class="mb-1 mt-1 title"><b>Tipo di rimborso</b></p>
            <div id="money" class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 pl-3 pr-0 mt-4 pt-3 pb-2 cardChoice">
                <div class="row mb-1">
                    <div class="col-xl-11 col-lg-11 col-md-11 col-sm-10 col-xs-10 col-10">
                        <p class="mb-1">Rimborso monetario</p>
                    </div>
                    <div class="mr-2">
            ...
            <div id="product" class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 pl-3 pr-0 mt-4 pt-3 pb-2 cardChoice">
                <div class="row mb-1">
                    <div class="col-xl-11 col-lg-11 col-md-11 col-sm-10 col-xs-10 col-10">
                        <p class="mb-1">Reinvio del prodotto</p>
                    </div>
                    <div>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <button id="submit-damagedOrderChoice" style="display: none;" type="button" class="btn col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3 col-6 float-right" onclick=""><b>Avanti</b></button>
                </div>
            </div>
        </div>
    </div>
