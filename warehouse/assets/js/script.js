(() => {
    ...
    $('#missingDeliveryForm').click(() => {
        window.location.href = 'complaintChoice.php?code=' + code + '&type=missing_product';
    });
    $('#damagedArticleForm').click(() => {
        window.location.href = 'complaintChoice.php?code=' + code + '&type=damaged_product'
    });
    $('#wrongArticleForm').click(() => {
        window.location.href = 'complaintChoice.php?code=' + code + '&type=wrong_product'
    });


    $("#submit-wrongOrderChoice").click(() => {
        if ($("#wrongOrderChoice #money").attr('selected') == 'selected') {
            window.location.href = '/confirmedReturn.php?code=' + code + '&type=change_version&goon=false'
        } else {
            window.location.href = '/confirmedReturn.php?code=' + code + '&type=refund&goon=false'
        }
    });

    $("#submit-damagedOrderChoice").click(() => {
        if ($("#damagedOrderChoice #money").attr('selected') == 'selected') {
            window.location.href = '/confirmedReturn.php?code=' + code + '&type=money&goon=false'
        } else {
            window.location.href = '/confirmedReturn.php?code=' + code + '&type=product&goon=false'
        }
    });


    $('#confirmed-return').click(() => {
        window.location.href = '/confirmedReturn.php?code=' + code + '&type=' + type + '&goon=true';
    });
