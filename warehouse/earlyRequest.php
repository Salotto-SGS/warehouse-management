...
<head lang="it" dir="ltr">
    ...
    <title>Magazzino - Early Request</title>
...
<body id="earlyRequest">

    <div class="container" style="height: 100vh;">
        <div class="row content">
            <div class="col-7"><img class="image" src="./assets/img/early-request.svg" alt="" draggable='false'></div>
            <div class="col-5">
                <div class="row">
                    <div class="col-12">
                        <h6 class="content-header">Richiesta prematura</h6>
                        <hr class="content-line">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h1 class="content-title">Uh oh... Di già?</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
